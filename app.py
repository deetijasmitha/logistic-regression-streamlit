...
@st.cache_resource
def load_model():
    model = joblib.load("C:/Users/K. Lakhan/OneDrive/Desktop/COE/LOGISTIC REGRESSION/logistic_regression_model.pkl")
    return model
...
try:
    ...
    st.error(f"❌ Error: {e}")
    st.info("Make sure the model file is saved at: C:/Users/K. Lakhan/OneDrive/Desktop/COE/LOGISTIC REGRESSION/logistic_regression_model.pkl")
